...
export const SaveIcon=(props:IconProps)=>{
    return <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="size-7" strokeWidth={1.5} viewBox="0 0 32 32" id="save">
    <path  d="m24 24.956-7.386-5.745a.999.999 0 0 0-1.228-.001L8 24.956V8c0-.551.449-1 1-1h14c.551 0 1 .449 1 1v16.956z"></path>
